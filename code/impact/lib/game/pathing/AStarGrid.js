...
.defines(function () {
    ...
    AStarGrid = ig.Class.extend({
        ...
        init: function (terrainFlag, width, height, defaultTerrain) {
            ...
            for(var i = 0; i < height; i++) {
                ...
                for(var j = 0; j < width; j++) {
                    this.data[i][j] = new AStarNode(j, i, defaultTerrain, this);
                }
            }
        },
        ...
        //TODO: If this is used much, hold onto a list of nodes of each terrain type
        //TODO: Otherwise this can be really expensive
        ...
        //TODO: If this is used much, hold onto a list of nodes of each terrain type/clearance
        //TODO: Otherwise this can be really expensive
